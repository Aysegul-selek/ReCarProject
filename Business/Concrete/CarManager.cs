...
namespace Business.Concrete
{
    public class CarManager : ICarServices
    {
        ...
        {
            return new SuccessDataResult<List<CarDetailDto>>(_cars.GetCarDetailByCarId(carId));
        }

        IDataResult<List<CarDetailDto>> ICarServices.GetCarsByBrandId(int brandId)
        {
        ...
        {
            return new SuccessDataResult<List<CarDetailDto>>(_cars.GetCarDetailByColorId(colorId));
        }

        public IDataResult<List<CarDetailDto>> GetCarDetailsByColorAndBrand(int brandId, int colorId)
        {
            return new SuccessDataResult<List<CarDetailDto>>(_cars.GetCarDetailsByBrandAndColor(brandId, colorId));
        }
    }
}
